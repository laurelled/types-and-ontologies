...
\mainmatter
%%INTRODUCTION
\input{body/examples/introduction.tex}
\clearemptydoublepage
%% CHAPTERS
% add any further chapter file here
\input{body/state-of-art.tex}
\clearemptydoublepage
\input{body/examples/chapter1.tex}
\clearemptydoublepage
\input{body/examples/chapter2.tex}
\clearemptydoublepage
\input{body/examples/chapter3.tex}
\clearemptydoublepage
\input{body/examples/chapter4.tex}
\clearemptydoublepage
