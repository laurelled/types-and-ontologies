...
\section{OCaml Module - Type Checking}\label{sec:Type Checking}
        ...
        sintattiche quindi \code{typeof} è sufficiente per la loro implementazione, altre come le regole di subtyping o [T-ADD] è necessario utilizzare funzioni di supporto
        ...
        \subsection{La regola [T-PROJ]}
            ...
            \begin{minted}[]{ocaml}
                subtype : Context -> Ty -> Ty -> Bool
            \end{minted}
            Prende in input un contesto e due tipi e ritorna \code{true} se e solo se $K \vDash C \sqsubseteq D$. la funzione subtype viene poi richiamata su tutte le regole
