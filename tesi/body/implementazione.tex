...
Infine chiediamo al reasoner HermiT di testare la soddisfacibilità di ogni concetto atomico presente negli assiomi di Leinberger. Se sono tutti soddisfacibili, allora significa che la query è abitabile, altrimenti non lo è.
    ...
    Vorremmo quindi valutare vantaggi e efficienza di un controllo statico, sfruttando i sistemi di tipi per assicurare la correttezza del programma, rispetto a 
    ...
    \\ Il linguaggio sfrutta le concept expression della logica descrittiva come tipo, interrogando la base di conoscenza e facendo inferenza durante il type checking.
    ...
    \end{itemize}
    Il sistema di tipi del linguaggio è corretto, ovvero un termine chiuso e ben tipato non si blocca durante la valutazione.
